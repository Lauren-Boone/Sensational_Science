import "package:sensational_science/locationhelper_nonweb.dart"
...
import "package:sensational_science/locationhelper_nonweb.dart"
    if (dart.library.html) 'package:sensational_science/locationhelper.dart';
...
class _UserLocationInfoState extends State<UserLocationInfo> {
  ...
  var value =
      "Please wait for text after pressing button for location. You may click next after the coordinates appear";
  //     getUserLocation(){
              ...
              onPressed: () {
                ...
                if (!kIsWeb) {
                  ...
                  getCurrentPosition(allowInterop((pos) {
                    ...
                    writeString(widget.code, widget.userLocationController.text,
                        widget.questionNum.toString());
