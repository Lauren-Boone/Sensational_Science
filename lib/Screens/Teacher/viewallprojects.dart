...
class ViewPublicStaging extends StatefulWidget {
  ...
  final String uid;
  ViewPublicStaging(
      this.title, this.projectID, this.projInfo, this.createdProjID, this.uid);

  @override
  _ViewPublicStagingState createState() => _ViewPublicStagingState(
      this.title, this.projectID, this.projInfo, this.createdProjID, this.uid);
}
...
class _ViewPublicStagingState extends State<ViewPublicStaging> {
  ...
  checkforProject() async {
    final existingProjects = await Firestore.instance
        .collection('Teachers')
        .document(uid)
        .collection('Created Projects')
        .getDocuments();
